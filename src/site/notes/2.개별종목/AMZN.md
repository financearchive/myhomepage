---
{"dg-publish":true,"permalink":"/2.개별종목/AMZN/","created":"2023-07-12T10:42:22.768+09:00","updated":"2025-07-25T20:14:44.793+09:00"}
---
...
- 2025년
	- [[0.DAILY-Invest/2025/07/2025-07-22\|2025-07-22]], 트럼프와 머스크의 갈등에 대안으로 떠오르는 아마존
	  
	  22 일, 트럼프 행정부가 차세대 미국의 미사일 방어막 ‘[[1.Study/2.산업/항공,우주,방위 산업/2.우주/INFO_우주/골든돔\|골든돔]]’ 구축에 아마존의 [[카이퍼 프로젝트\|카이퍼 프로젝트]]를 적용한다는 내용이 보도됐다. 
	  
	  연초까지만 하더라도 트럼프 대통령과 가까웠던 일론 머스크의 스페이스X(스타링크)를 중심으로 사업이 전개될 것으로 예상됐으나, 최근 일론 머스크와 트럼프 대통령 간의 갈등이 커지게 되면서 트럼프 행정부도 [[2.개별종목/SpaceX\|SpaceX]]에 대한 의존도를 낮추고 사업 기회를 다변화하고자 하는 움직임이 나타나기 시작했다
...
산업: [[전자상거래 및 클라우드 서비스\|전자상거래 및 클라우드 서비스]] (E-commerce and Cloud Services)

---

## 영위사업

Amazon.com Inc.는 1994년 Jeff Bezos가 설립한 세계 최대 [[전자상거래\|전자상거래]] 및 [[클라우드 컴퓨팅\|클라우드 컴퓨팅]] 기업으로, 온라인 소매, 클라우드 서비스, 디지털 광고, 구독 서비스 등 다양한 사업을 운영하고 있습니다. 회사는 "고객 중심주의"를 핵심 가치로 삼아 지속적인 혁신과 확장을 통해 글로벌 시장을 선도하고 있습니다.
...
- 기업 고객: AWS 클라우드 서비스 이용 - Netflix(US, [[2.개별종목/NFLX\|NFLX]]), Airbnb(US, [[2.개별종목/ABNB\|ABNB]])
- 광고주: 온라인 광고 서비스 이용 - Procter & Gamble(US, [[2.개별종목/PG\|PG]]), Unilever(UK, [[UL\|UL]])
- 정부 기관: 공공 클라우드 서비스 이용 - 미국 정부, CIA, NASA

**후방산업:**

- 물류 서비스업: 배송 및 창고 운영 - UPS(US, [[2.개별종목/UPS\|UPS]]), FedEx(US, [[2.개별종목/FDX\|FDX]])
- 반도체 제조업: 서버 및 데이터 센터용 칩 공급 - Intel(US, [[2.개별종목/INTC\|INTC]]), AMD(US, [[2.개별종목/AMD\|AMD]])
- 포장재 제조업: 배송용 포장 자재 공급 - International Paper(US, [[2.개별종목/IP\|IP]]), Smurfit Kappa(IE, [[SKG\|SKG]])
- 부동산 임대업: 물류 센터 및 데이터 센터 부지 임대 - Prologis(US, [[2.개별종목/PLD\|PLD]]), Digital Realty(US, [[2.개별종목/DLR\|DLR]])
...
- Procter & Gamble(US, [[2.개별종목/PG\|PG]]) - 생활용품 및 소비재 공급
- Unilever(UK, [[UL\|UL]]) - 식품 및 개인용품 공급
- Nike(US, [[2.개별종목/NKE\|NKE]]) - 스포츠 용품 및 의류 공급
- Apple(US, [[2.개별종목/AAPL\|AAPL]]) - 전자제품 공급
- Samsung(KR, [[1.Study/3.테마/VR,AR,MR/종목/Samsung\|Samsung]]) - 전자제품 및 가전제품 공급

**물류 및 배송 단계:** 글로벌 물류 네트워크 운영

- UPS(US, [[2.개별종목/UPS\|UPS]]) - 마지막 마일 배송 파트너
- FedEx(US, [[2.개별종목/FDX\|FDX]]) - 국제 배송 파트너
- DHL(DE, [[DHL\|DHL]]) - 국제 익스프레스 배송
- USPS(US, [[USPS\|USPS]]) - 미국 내 배송 파트너

**기술 인프라 단계:** 클라우드 및 IT 인프라 구축

- Intel(US, [[2.개별종목/INTC\|INTC]]) - 서버용 프로세서 공급
- NVIDIA(US, [[2.개별종목/NVDA\|NVDA]]) - AI 및 GPU 칩 공급
- Microsoft(US, [[2.개별종목/MSFT\|MSFT]]) - 소프트웨어 및 클라우드 경쟁/협력
- Oracle(US, [[2.개별종목/ORCL\|ORCL]]) - 데이터베이스 및 클라우드 경쟁

**콘텐츠 및 서비스 단계:** 디지털 콘텐츠 및 부가 서비스

- Netflix(US, [[2.개별종목/NFLX\|NFLX]]) - 스트리밍 서비스 경쟁
- Spotify(SE, [[2.개별종목/SPOT\|SPOT]]) - 음악 스트리밍 서비스 경쟁
- Disney(US, [[2.개별종목/DIS\|DIS]]) - 콘텐츠 제작 및 라이선스

---

## 주요제품

**온라인 스토어:** 직접 판매 전자상거래 플랫폼, 매출 비중 약 25% (2024년 기준), 관련 경쟁사 [[2.개별종목/WMT\|WMT]], [[2.개별종목/TGT\|TGT]]

**서드파티 셀러 서비스:** 마켓플레이스 수수료 사업, 매출 비중 약 25% (2024년 기준), 관련 경쟁사 [[2.개별종목/EBAY\|EBAY]], [[2.개별종목/ETSY\|ETSY]]

**AWS:** 클라우드 컴퓨팅 인프라 서비스, 매출 비중 약 19% (2024년 기준), 관련 경쟁사 [[2.개별종목/MSFT\|MSFT]], [[2.개별종목/GOOGL\|GOOGL]]

**광고 서비스:** 온라인 광고 및 마케팅 서비스, 매출 비중 약 11% (2024년 기준), 관련 경쟁사 [[2.개별종목/GOOGL\|GOOGL]], [[2.개별종목/META\|META]]

**구독 서비스:** 아마존 프라임 등 구독 서비스, 매출 비중 약 6% (2024년 기준), 관련 경쟁사 [[2.개별종목/NFLX\|NFLX]], [[2.개별종목/DIS\|DIS]]
...
- 주요 공급 지역: 대만, 한국, 미국
- 주요 공급 업체: Intel [[2.개별종목/INTC\|INTC]], AMD [[2.개별종목/AMD\|AMD]], NVIDIA [[2.개별종목/NVDA\|NVDA]]

**포장재:**

- 사용처: 상품 배송용 박스, 보호재, 라벨
- 주요 공급 지역: 미국, 중국, 유럽
- 주요 공급 업체: International Paper [[2.개별종목/IP\|IP]], Smurfit Kappa [[SKG\|SKG]]

**배터리:**

- 사용처: 전자기기, 물류 로봇, 백업 전원
- 주요 공급 지역: 중국, 한국, 일본
- 주요 공급 업체: Samsung SDI [[Samsung SDI\|Samsung SDI]], CATL [[2.개별종목/CATL\|CATL]]
...
- Netflix(US, [[2.개별종목/NFLX\|NFLX]]) - AWS 클라우드 서비스, 스트리밍 인프라
- Airbnb(US, [[2.개별종목/ABNB\|ABNB]]) - AWS 클라우드 서비스, 플랫폼 인프라
- Spotify(SE, [[2.개별종목/SPOT\|SPOT]]) - AWS 클라우드 서비스, 음악 스트리밍 인프라
- Disney(US, [[2.개별종목/DIS\|DIS]]) - AWS 클라우드 서비스, 콘텐츠 배포
- Samsung(KR, [[1.Study/3.테마/VR,AR,MR/종목/Samsung\|Samsung]]) - AWS 클라우드 서비스, 글로벌 IT 인프라
- General Electric(US, [[2.개별종목/GE\|GE]]) - AWS 클라우드 서비스, 산업용 IoT
- Johnson & Johnson(US, [[2.개별종목/JNJ\|JNJ]]) - AWS 클라우드 서비스, 헬스케어 솔루션
- Ford Motor(US, [[2.개별종목/F\|F]]) - AWS 클라우드 서비스, 자동차 연결 서비스
- Kellogg's(US, [[2.개별종목/K\|K]]) - AWS 클라우드 서비스, 공급망 관리
- Unilever(UK, [[UL\|UL]]) - AWS 클라우드 서비스, 글로벌 운영 시스템
- Shell(NL, [[Shell\|Shell]]) - AWS 클라우드 서비스, 에너지 데이터 분석
- Expedia(US, [[2.개별종목/EXPE\|EXPE]]) - AWS 클라우드 서비스, 여행 플랫폼
- Comcast(US, [[2.개별종목/CMCSA\|CMCSA]]) - AWS 클라우드 서비스, 미디어 인프라
- Bristol-Myers Squibb(US, [[2.개별종목/BMY\|BMY]]) - AWS 클라우드 서비스, 제약 연구
- Pfizer(US, [[2.개별종목/PFE\|PFE]]) - AWS 클라우드 서비스, 의료 데이터 분석
- SAP(DE, [[SAP\|SAP]]) - AWS 클라우드 서비스, 기업용 소프트웨어
- Oracle(US, [[2.개별종목/ORCL\|ORCL]]) - AWS 클라우드 서비스, 데이터베이스 호스팅
- Salesforce(US, [[2.개별종목/CRM\|CRM]]) - AWS 클라우드 서비스, CRM 플랫폼
- Adobe(US, [[2.개별종목/ADBE\|ADBE]]) - AWS 클라우드 서비스, 크리에이티브 소프트웨어
- Zoom(US, [[2.개별종목/ZM\|ZM]]) - AWS 클라우드 서비스, 화상회의 인프라
...
- Walmart(US, [[2.개별종목/WMT\|WMT]]) - 전자상거래 플랫폼, 미국 2위 온라인 리테일러
- Microsoft(US, [[2.개별종목/MSFT\|MSFT]]) - Azure 클라우드 서비스, AWS 2위 경쟁사
- Google(US, [[2.개별종목/GOOGL\|GOOGL]]) - Google Cloud Platform, 클라우드 3위 경쟁사
- Alibaba(CN, [[2.개별종목/BABA\|BABA]]) - 중국 전자상거래 플랫폼, 아시아 시장 점유율 1위
- eBay(US, [[2.개별종목/EBAY\|EBAY]]) - 온라인 마켓플레이스, C2C 중심 플랫폼
- Target(US, [[2.개별종목/TGT\|TGT]]) - 온라인 소매, 옴니채널 전략
- Best Buy(US, [[2.개별종목/BBY\|BBY]]) - 전자제품 온라인 소매
- Home Depot(US, [[2.개별종목/HD\|HD]]) - DIY 및 건설 자재 온라인 판매
- Costco(US, [[2.개별종목/COST\|COST]]) - 창고형 매장 및 온라인 판매
- Apple(US, [[2.개별종목/AAPL\|AAPL]]) - 클라우드 서비스 (iCloud), 디지털 콘텐츠
- Meta(US, [[2.개별종목/META\|META]]) - 디지털 광고, 온라인 마케팅 경쟁
- Shopify(CA, [[2.개별종목/SHOP\|SHOP]]) - 전자상거래 플랫폼 솔루션
- Oracle(US, [[2.개별종목/ORCL\|ORCL]]) - 클라우드 데이터베이스 서비스
- IBM(US, [[2.개별종목/IBM\|IBM]]) - 엔터프라이즈 클라우드 서비스
- Salesforce(US, [[2.개별종목/CRM\|CRM]]) - 클라우드 기반 CRM 솔루션
- JD.com(CN, [[2.개별종목/JD\|JD]]) - 중국 전자상거래 플랫폼
- Pinduoduo(CN, [[2.개별종목/PDD\|PDD]]) - 중국 소셜 커머스 플랫폼
- Rakuten(JP, [[Rakuten\|Rakuten]]) - 일본 전자상거래 플랫폼
- MercadoLibre(AR, [[2.개별종목/MELI\|MELI]]) - 라틴아메리카 전자상거래
- Sea Limited(SG, [[2.개별종목/SE\|SE]]) - 동남아시아 전자상거래 (Shopee)
