---
{"dg-publish":true,"permalink":"/2.개별종목/GOOGL/","created":"2023-07-14T10:40:11.308+09:00","updated":"2025-07-10T13:13:23.786+09:00"}
---
...
산업: [[인터넷 소프트웨어 및 서비스\|인터넷 소프트웨어 및 서비스]] (Internet Software & Services)
...
- 광고주 기업: 디지털 마케팅을 위한 광고 플랫폼 이용 - P&G(US, [[2.개별종목/PG\|PG]]), Coca-Cola(US, [[2.개별종목/KO\|KO]])
- 개발자 및 앱 제작사: 안드로이드 및 구글 플레이 스토어 이용 - Epic Games(US, [[Epic Games\|Epic Games]])
- 기업 고객: 구글 워크스페이스 및 클라우드 서비스 이용 - Airbnb(US, [[2.개별종목/ABNB\|ABNB]]), Snapchat(US, [[2.개별종목/SNAP\|SNAP]])
- 콘텐츠 제작자: 유튜브 플랫폼 이용 - 개인 크리에이터 및 미디어 회사들

**후방산업:**

- 반도체 제조업: 서버 및 데이터센터용 칩 공급 - Intel(US, [[2.개별종목/INTC\|INTC]]), AMD(US, [[2.개별종목/AMD\|AMD]])
- 데이터센터 인프라: 서버 및 네트워킹 장비 공급 - Cisco(US, [[2.개별종목/CSCO\|CSCO]]), Dell(US, [[2.개별종목/DELL\|DELL]])
- 클라우드 하드웨어: 스토리지 및 컴퓨팅 하드웨어 - HPE(US, [[2.개별종목/HPE\|HPE]]), NetApp(US, [[2.개별종목/NTAP\|NTAP]])
...
- Alphabet(US, [[2.개별종목/GOOGL\|GOOGL]]) - 검색, 유튜브, 안드로이드 플랫폼 운영
- 클라우드 인프라 파트너 - 데이터센터 운영 지원
- 네트워크 인프라 업체 - Cisco(US, [[2.개별종목/CSCO\|CSCO]]), Juniper(US, [[2.개별종목/JNPR\|JNPR]]) - 네트워크 장비 공급
- 하드웨어 제조업체 - Intel(US, [[2.개별종목/INTC\|INTC]]), AMD(US, [[2.개별종목/AMD\|AMD]]) - 서버 칩 공급

**광고 및 수익화 단계:** 광고주와 사용자 연결

- 광고주 기업 - P&G(US, [[2.개별종목/PG\|PG]]), Unilever(NL, [[UL\|UL]]) - 광고 투자
- 광고 대행사 - WPP(UK, [[WPP\|WPP]]), Omnicom(US, [[2.개별종목/OMC\|OMC]]) - 광고 캠페인 관리
- 이커머스 업체 - Amazon(US, [[2.개별종목/AMZN\|AMZN]]), Shopify(CA, [[2.개별종목/SHOP\|SHOP]]) - 상품 광고 및 판매
...
**Google Search:** 검색엔진 서비스, 매출 비중 약 57% (2024년 기준), 관련 경쟁사 [[2.개별종목/MSFT\|MSFT]], [[2.개별종목/BIDU\|BIDU]]

**YouTube:** 동영상 플랫폼 및 광고 서비스, 매출 비중 약 11% (2024년 기준), 관련 경쟁사 [[2.개별종목/META\|META]], [[2.개별종목/NFLX\|NFLX]]

**Google Cloud:** 클라우드 인프라 및 워크스페이스, 매출 비중 약 13% (2024년 기준), 관련 경쟁사 [[2.개별종목/AMZN\|AMZN]], [[2.개별종목/MSFT\|MSFT]]

**Google Network:** 파트너 사이트 광고 네트워크, 매출 비중 약 7% (2024년 기준), 관련 경쟁사 [[2.개별종목/META\|META]], [[2.개별종목/AMZN\|AMZN]]

**Other Google Services:** 구글 플레이, 픽셀, 구독 서비스, 매출 비중 약 12% (2024년 기준), 관련 경쟁사 [[2.개별종목/AAPL\|AAPL]], [[2.개별종목/MSFT\|MSFT]]
...
- 주요 공급 지역: 미국, 일본, 독일
- 주요 공급 업체: Corning [[2.개별종목/GLW\|GLW]], Prysmian [[PRY\|PRY]]

**스토리지 하드웨어:**

- 사용처: 데이터 저장 및 백업
- 주요 공급 지역: 미국, 일본, 한국
- 주요 공급 업체: Western Digital [[2.개별종목/WDC\|WDC]], Seagate [[2.개별종목/STX\|STX]]
...
- P&G(US, [[2.개별종목/PG\|PG]]) - 소비재 기업, 디지털 광고 투자
- Coca-Cola(US, [[2.개별종목/KO\|KO]]) - 음료 기업, 브랜드 광고
- Nike(US, [[2.개별종목/NKE\|NKE]]) - 스포츠용품 기업, 디지털 마케팅
- McDonald's(US, [[2.개별종목/MCD\|MCD]]) - 외식 기업, 로컬 광고
- Airbnb(US, [[2.개별종목/ABNB\|ABNB]]) - 여행 플랫폼, 구글 클라우드 고객
- Snapchat(US, [[2.개별종목/SNAP\|SNAP]]) - 소셜미디어, 구글 클라우드 이용
- Spotify(US, [[2.개별종목/SPOT\|SPOT]]) - 음악 스트리밍, 구글 클라우드 서비스
- Uber(US, [[2.개별종목/UBER\|UBER]]) - 차량 공유, 구글 클라우드 및 맵스 API
- Netflix(US, [[2.개별종목/NFLX\|NFLX]]) - 스트리밍 서비스, 구글 클라우드 고객
- Walmart(US, [[2.개별종목/WMT\|WMT]]) - 소매업, 디지털 광고 및 클라우드 서비스
...
- Microsoft(US, [[2.개별종목/MSFT\|MSFT]]) - Bing 검색엔진, Azure 클라우드 서비스, 검색 시장 점유율 3.9%
- Amazon(US, [[2.개별종목/AMZN\|AMZN]]) - AWS 클라우드 서비스, 디지털 광고 플랫폼, 클라우드 시장 1위
- Meta(US, [[2.개별종목/META\|META]]) - Facebook, Instagram 소셜미디어 광고, 디지털 광고 시장 2위
- Apple(US, [[2.개별종목/AAPL\|AAPL]]) - Safari 브라우저, 앱스토어, 모바일 생태계 경쟁
- ByteDance(CN, [[2.개별종목/ByteDance\|ByteDance]]) - TikTok 동영상 플랫폼, 유튜브 경쟁
- Baidu(CN, [[2.개별종목/BIDU\|BIDU]]) - 중국 검색엔진 1위, 중국 시장 검색 서비스
- Tencent(CN, [[Tencent\|Tencent]]) - WeChat, 중국 클라우드 서비스
- Alibaba(CN, [[Alibaba\|Alibaba]]) - 알리바바 클라우드, 중국 클라우드 시장 3위
- Oracle(US, [[2.개별종목/ORCL\|ORCL]]) - 엔터프라이즈 클라우드 서비스
- Salesforce(US, [[2.개별종목/CRM\|CRM]]) - 고객관계관리 클라우드 서비스
- Netflix(US, [[2.개별종목/NFLX\|NFLX]]) - 동영상 스트리밍 서비스, 유튜브 경쟁
- Yandex(RU, [[Yandex\|Yandex]]) - 러시아 검색엔진 1위
- DuckDuckGo(US, [[DuckDuckGo\|DuckDuckGo]]) - 프라이버시 중심 검색엔진
- Yahoo(US, [[Yahoo\|Yahoo]]) - 검색 및 포털 서비스
- IBM(US, [[2.개별종목/IBM\|IBM]]) - 하이브리드 클라우드 서비스
...
- iShares MSCI World Information Technology ETF - [[WCLD\|WCLD]]
