...
Rubrik Inc.는 2014년 설립된 미국의 [클라우드 데이터 관리] 및 [[1.Study/★ 산업/보안/INFO_보안/사이버 보안\|사이버 보안]] 전문 기업으로, 엔터프라이즈 고객을 위한 포괄적인 [데이터 보안 플랫폼]을 제공합니다. 회사는 '제로 트러스트 데이터 보안' 접근 방식을 통해 [[온프레미스\|온프레미스]], [[1.Study/★ 산업/클라우드/클라우드\|클라우드]], [[1.Study/★ 산업/클라우드/SaaS\|SaaS]] 환경에서 데이터를 보호하고 관리하는 통합 솔루션을 제공합니다.
