---
{"dg-publish":true,"permalink":"/2.개별종목/APLD/","created":"2025-01-15T20:52:09.569+09:00","updated":"2025-07-10T14:35:47.451+09:00"}
---
...
산업: [[IT 서비스\|IT 서비스]] (IT Services & Other Tech)
...
Applied Digital의 비즈니스 모델은 디지털 인프라 제공을 기반으로 한 [[1.Study/2.산업/통신_데이터센터 산업/2.데이터센터/데이터센터\|데이터센터]] 운영 플랫폼입니다.
...
**2. [[1.Study/2.산업/클라우드/클라우드\|클라우드]] 서비스 사업 (매출 39% 비중):**
...
- 클라우드 서비스 업체: CoreWeave(US, [[CoreWeave\|CoreWeave]]), Lambda Labs 등
...
- GPU 제조업체: NVIDIA(US, [[2.개별종목/NVDA\|NVDA]]), AMD(US, [[2.개별종목/AMD\|AMD]])
- 서버 제조업체: Supermicro(US, [[2.개별종목/SMCI\|SMCI]]), Dell(US, [[2.개별종목/DELL\|DELL]])
- 건설업체: 데이터센터 건설 - 현지 건설업체
- 냉각 시스템 업체: 데이터센터 냉각 솔루션 제공업체
- 전력 인프라 업체: ABB(CH, [[2.개별종목/ABB\|ABB]]), Schneider Electric(FR, [[Schneider Electric\|Schneider Electric]])
...
- 풍력 발전소 - 재생에너지 공급
- ABB(CH, [[2.개별종목/ABB\|ABB]]) - 중전압 전력 인프라 솔루션
- Schneider Electric(FR, [[Schneider Electric\|Schneider Electric]]) - 전력 관리 시스템

**데이터센터 인프라 단계:** 하드웨어 및 시설 구축

- NVIDIA(US, [[2.개별종목/NVDA\|NVDA]]) - GPU 하드웨어 공급
- Supermicro(US, [[2.개별종목/SMCI\|SMCI]]) - 서버 하드웨어 공급
...
- CoreWeave(US, [[CoreWeave\|CoreWeave]]) - AI 클라우드 서비스 파트너
- Lambda Labs(US, [[Lambda Labs\|Lambda Labs]]) - GPU 클라우드 경쟁업체
...
**데이터센터 호스팅 서비스:** AI/HPC 특화 데이터센터 임대, 매출 비중 약 61% (2024년 기준), 관련 경쟁사 [[2.개별종목/DLR\|DLR]], [[2.개별종목/EQIX\|EQIX]]

**클라우드 서비스:** 관리형 GPU 컴퓨팅 서비스, 매출 비중 약 39% (2024년 기준), 관련 경쟁사 [[2.개별종목/GOOGL\|GOOGL]], [[2.개별종목/MSFT\|MSFT]]

**암호화폐 마이닝 호스팅:** 비트코인 마이닝 호스팅 서비스, 데이터센터 호스팅 부문 포함, 관련 경쟁사 [[2.개별종목/RIOT\|RIOT]], [[2.개별종목/MARA\|MARA]]

**AI 인프라 서비스:** GPU 클러스터 관리 및 AI 트레이닝 플랫폼, 클라우드 서비스 부문 포함, 관련 경쟁사 [[2.개별종목/NVDA\|NVDA]], [[2.개별종목/GOOGL\|GOOGL]]
...
- 주요 공급 지역: 대만, 중국, 미국
- 주요 공급 업체: NVIDIA [[2.개별종목/NVDA\|NVDA]], Supermicro [[2.개별종목/SMCI\|SMCI]]
...
- CoreWeave(US, [[CoreWeave\|CoreWeave]]) - AI 클라우드 서비스 업체, 15년간 70억 달러 계약
...
- Equinix(US, [[2.개별종목/EQIX\|EQIX]]) - 글로벌 데이터센터 REIT, 콜로케이션 서비스
- Digital Realty Trust(US, [[2.개별종목/DLR\|DLR]]) - 데이터센터 REIT, 대형 데이터센터 운영
- Core Scientific(US, [[2.개별종목/CORZ\|CORZ]]) - 암호화폐 마이닝 및 AI 데이터센터 운영
- Riot Platforms(US, [[2.개별종목/RIOT\|RIOT]]) - 비트코인 마이닝 및 데이터센터 운영
- Marathon Digital(US, [[2.개별종목/MARA\|MARA]]) - 비트코인 마이닝 및 디지털 자산 인프라
- Cipher Mining(US, [[CIFR\|CIFR]]) - 비트코인 마이닝 및 데이터센터 개발
- Hut 8 Mining(US, [[2.개별종목/HUT\|HUT]]) - 비트코인 마이닝 및 AI 인프라 서비스
- Iris Energy(US, [[2.개별종목/IREN\|IREN]]) - 비트코인 마이닝 및 AI 컴퓨팅 서비스
- CleanSpark(US, [[2.개별종목/CLSK\|CLSK]]) - 비트코인 마이닝 및 에너지 솔루션
- Bitfarms(US, [[BITF\|BITF]]) - 비트코인 마이닝 및 지속가능한 에너지
- CoreWeave(US, [[CoreWeave\|CoreWeave]]) - AI 클라우드 서비스 (파트너이자 잠재 경쟁사)
- Lambda Labs(US, [[Lambda Labs\|Lambda Labs]]) - GPU 클라우드 서비스
- Crusoe Energy(US, [[Crusoe Energy\|Crusoe Energy]]) - 에너지 효율적 컴퓨팅 인프라
- Amazon Web Services(US, [[2.개별종목/AMZN\|AMZN]]) - 클라우드 서비스 (GPU 컴퓨팅 부문)
- Google Cloud(US, [[2.개별종목/GOOGL\|GOOGL]]) - 클라우드 서비스 (AI/ML 인프라 부문)
...
- Global X Data Center REITs & Digital Infrastructure ETF - [[DXJ\|DXJ]]
- Pacer Benchmark Data & Infrastructure Real Estate ETF - [[SRVR\|SRVR]]
