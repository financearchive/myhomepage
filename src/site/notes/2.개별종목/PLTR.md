---
{"dg-publish":true,"permalink":"/2.개별종목/PLTR/","created":"2024-09-10T16:28:10.728+09:00","updated":"2025-08-04T20:48:46.984+09:00"}
---
...
- 2025년
	- [[0.DAILY Invest/☆ 2025/8월/2025-08-02\|2025-08-02]], 팔란티어 테크놀로지스, 실적으로 성장을 증명하자 - 2Q25 실적 프리뷰
...
산업: [[소프트웨어 응용프로그램\|소프트웨어 응용프로그램]] (Software Application)
...
- 헬스케어: 의료 데이터 분석 및 임상 연구 - Johnson & Johnson(US, [[2.개별종목/JNJ\|JNJ]]), Pfizer(US, [[2.개별종목/PFE\|PFE]])
- 금융 서비스: 리스크 관리 및 사기 탐지 - JPMorgan Chase(US, [[2.개별종목/JPM\|JPM]]), Bank of America(US, [[2.개별종목/BAC\|BAC]])
- 제조업: 공급망 최적화 및 운영 효율성 - Boeing(US, [[2.개별종목/BA\|BA]]), Lockheed Martin(US, [[2.개별종목/LMT\|LMT]])

**후방산업:**

- 클라우드 인프라: 데이터 처리 및 저장 인프라 - Amazon Web Services(US, [[2.개별종목/AMZN\|AMZN]]), Microsoft Azure(US, [[2.개별종목/MSFT\|MSFT]])
- 하드웨어 제조: 서버 및 스토리지 하드웨어 - Dell(US, [[2.개별종목/DELL\|DELL]]), HPE(US, [[2.개별종목/HPE\|HPE]])
- 소프트웨어 라이선스: 개발 도구 및 데이터베이스 - Oracle(US, [[2.개별종목/ORCL\|ORCL]]), Microsoft(US, [[2.개별종목/MSFT\|MSFT]])
- 데이터 제공업체: 외부 데이터 소스 및 API - Thomson Reuters(CA, [[TRI\|TRI]]), Bloomberg(US, [[Bloomberg\|Bloomberg]])
...
- 데이터 제공업체 - Thomson Reuters(CA, [[TRI\|TRI]]), Bloomberg(US, [[Bloomberg\|Bloomberg]]) - 금융 및 뉴스 데이터
- 클라우드 서비스 - Amazon Web Services(US, [[2.개별종목/AMZN\|AMZN]]), Microsoft Azure(US, [[2.개별종목/MSFT\|MSFT]]) - 클라우드 인프라

**플랫폼 개발 및 구축 단계:** 소프트웨어 플랫폼 개발 및 배포

- Palantir(US, [[2.개별종목/PLTR\|PLTR]]) - 핵심 플랫폼 개발 및 제공
- 인프라 파트너 - Dell(US, [[2.개별종목/DELL\|DELL]]), HPE(US, [[2.개별종목/HPE\|HPE]]) - 하드웨어 인프라 공급
- 소프트웨어 파트너 - Oracle(US, [[2.개별종목/ORCL\|ORCL]]), Snowflake(US, [[2.개별종목/SNOW\|SNOW]]) - 데이터베이스 및 분석 도구
- 시스템 통합업체 - Accenture(US, [[2.개별종목/ACN\|ACN]]), Deloitte(US, [[Deloitte\|Deloitte]]) - 구현 및 컨설팅
...
**Gotham:** 정부 및 국방 분야 데이터 분석 플랫폼, 매출 비중 약 55% (2024년 기준), 관련 경쟁사 [[2.개별종목/IBM\|IBM]], [[2.개별종목/ORCL\|ORCL]]

**Foundry:** 상업 기업용 데이터 통합 및 분석 플랫폼, 매출 비중 약 45% (2024년 기준), 관련 경쟁사 [[2.개별종목/SNOW\|SNOW]], [[DBRX\|DBRX]]

**Apollo:** 지속적 통합/배포(CI/CD) 플랫폼, 전체 플랫폼 지원 도구, 관련 경쟁사 [[2.개별종목/MSFT\|MSFT]], [[2.개별종목/GOOGL\|GOOGL]]

**AIP (Artificial Intelligence Platform):** AI 기반 의사결정 지원 플랫폼, 2024년 출시, 관련 경쟁사 [[AI\|AI]], [[2.개별종목/NVDA\|NVDA]]

**Maven Smart System:** 미국 국방부 특화 AI 분석 시스템, 7.95억 달러 계약 수주, 관련 경쟁사 [[2.개별종목/BA\|BA]], [[2.개별종목/LMT\|LMT]]
...
- 사용처: 개발 도구 및 데이터베이스
- 주요 공급 지역: 미국, 유럽
- 주요 공급 업체: Oracle [[2.개별종목/ORCL\|ORCL]], Microsoft [[2.개별종목/MSFT\|MSFT]]
...
- Johnson & Johnson(US, [[2.개별종목/JNJ\|JNJ]]) - 임상 연구 및 의료 데이터 분석
- Pfizer(US, [[2.개별종목/PFE\|PFE]]) - 신약 개발 및 임상 시험
- JPMorgan Chase(US, [[2.개별종목/JPM\|JPM]]) - 리스크 관리 및 사기 탐지
- Bank of America(US, [[2.개별종목/BAC\|BAC]]) - 금융 데이터 분석
- Boeing(US, [[2.개별종목/BA\|BA]]) - 항공우주 데이터 분석
- Lockheed Martin(US, [[2.개별종목/LMT\|LMT]]) - 국방 계약 데이터 분석
- Airbus(FR, [[2.개별종목/AIR\|AIR]]) - 항공기 운영 최적화
- BP(UK, [[BP\|BP]]) - 에너지 데이터 분석
- Shell(NL, [[RDSA\|RDSA]]) - 석유 가스 운영 최적화
- Merck(US, [[2.개별종목/MRK\|MRK]]) - 제약 연구 개발
- Ferrari(IT, [[2.개별종목/RACE\|RACE]]) - 제조 및 공급망 최적화
...
- Snowflake(US, [[2.개별종목/SNOW\|SNOW]]) - 클라우드 데이터 웨어하우스 플랫폼, 데이터 분석 시장 경쟁
- Databricks(US, [[Databricks\|Databricks]]) - 데이터 및 AI 플랫폼, 기업용 분석 솔루션
- C3.ai(US, [[AI\|AI]]) - 엔터프라이즈 AI 애플리케이션, 정부 및 기업 AI 서비스
- IBM Watson(US, [[2.개별종목/IBM\|IBM]]) - 인공지능 분석 플랫폼, 기업용 AI 솔루션
- Microsoft(US, [[2.개별종목/MSFT\|MSFT]]) - Power BI, Azure AI, 비즈니스 인텔리전스 도구
- Oracle(US, [[2.개별종목/ORCL\|ORCL]]) - 데이터베이스 및 분석 플랫폼, 기업용 데이터 관리
- SAS Institute(US, [[SAS\|SAS]]) - 통계 분석 소프트웨어, 예측 분석 도구
- Tableau(US, [[2.개별종목/CRM\|CRM]]) - 데이터 시각화 플랫폼, 비즈니스 분석 도구
- Alteryx(US, [[AYX\|AYX]]) - 데이터 분석 및 처리 플랫폼
- Splunk(US, [[2.개별종목/SPLK\|SPLK]]) - 머신 데이터 분석 플랫폼, 보안 분석
- Qlik(US, [[Qlik\|Qlik]]) - 비즈니스 인텔리전스 플랫폼
- Looker(US, [[2.개별종목/GOOGL\|GOOGL]]) - 비즈니스 인텔리전스 및 데이터 플랫폼
- Dataiku(US, [[Dataiku\|Dataiku]]) - 데이터 사이언스 플랫폼
- H2O.ai(US, [[H2O.ai\|H2O.ai]]) - 머신러닝 및 AI 플랫폼
- DataRobot(US, [[DataRobot\|DataRobot]]) - 자동화된 머신러닝 플랫폼
