...
COVER는 2016년 설립된 [[1.Study/4.국가/일본/일본\|일본]]의 대표적인 [[1.Study/2.산업/인터넷미디어,웹툰 산업/버추얼 유튜버\|버추얼 유튜버]](이하 [[버튜버\|버튜버]]) [[에이전시\|에이전시]]로, 글로벌 버튜버 그룹 ‘[[홀로라이브 프로덕션\|홀로라이브 프로덕션]]’을 운영하고 있다. 
