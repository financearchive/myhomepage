---
{"dg-publish":true,"permalink":"/2.개별종목/RKLB/","created":"2024-11-07T12:05:11.504+09:00","updated":"2025-07-30T16:59:47.908+09:00"}
---
...
Rocket Lab USA, Inc.(NASDAQ: RKLB)는 [[소형 위성\|소형 위성]] 제조 및 발사에 중점을 둔 미국의 우주 항공 기업입니다. 2006년 뉴질랜드 출신의 피터 벡(Peter Beck)이 설립한 회사로, 현재는 미국 캘리포니아 롱비치에 본사를 두고 있습니다. Rocket Lab은 주로 세 가지 핵심 사업 영역에서 활동하고 있습니다: 1) 로켓 발사 서비스, 2) 우주선 제조 및 설계, 3) 우주 시스템 솔루션 제공입니다.
...
- 상업 위성 서비스: Planet Labs(US, [[2.개별종목/PL\|PL]]), Spire Global(US, [[2.개별종목/SPIR\|SPIR]]), BlackSky(US, [[2.개별종목/BKSY\|BKSY]])
- 위성 통신: Globalstar(US, [[2.개별종목/GSAT\|GSAT]]), Iridium Communications(US, [[2.개별종목/IRDM\|IRDM]])
- 지구 관측: Maxar Technologies(US, [[2.개별종목/MAXR\|MAXR]]), Satellogic(US, [[2.개별종목/SATL\|SATL]])
...
- 항공우주 소재: Hexcel Corporation(US, [[2.개별종목/HXL\|HXL]]), Toray Industries(JP, [[3402\|3402]])
- 전자 부품: Microchip Technology(US, [[2.개별종목/MCHP\|MCHP]]), Teledyne Technologies(US, [[2.개별종목/TDY\|TDY]])
- 로켓 엔진 부품: Aerojet Rocketdyne(US, [[2.개별종목/AJRD\|AJRD]]), DMG MORI(JP, [[6141\|6141]])
- 정밀 제조: Proto Labs(US, [[PRLB\|PRLB]]), Carpenter Technology(US, [[2.개별종목/CRS\|CRS]])
- 위성 통신 장비: L3Harris Technologies(US, [[2.개별종목/LHX\|LHX]]), Comtech Telecommunications(US, [[CMTL\|CMTL]])
...
- 탄소섬유 공급: Toray Industries(JP, [[3402\|3402]]) - 고강도 [[탄소섬유\|탄소섬유]] 제공 (로켓 동체 제작용)
- 전자 부품: NVIDIA(US, [[2.개별종목/NVDA\|NVDA]]) - 우주용 컴퓨팅 시스템 (위성 제어용)
- 추진제 공급: Air Liquide(FR, [[AI\|AI]]) - [[액체 산소\|액체 산소]] 및 연료 (로켓 추진용)
- 3D 프린팅 장비: EOS GmbH(DE) - 금속 3D 프린팅 시스템 (엔진 부품 제작)
- 특수 금속: Carpenter Technology(US, [[2.개별종목/CRS\|CRS]]) - 특수 합금 (엔진 및 구조용)
...
- 소형 위성 발사체, 최대 300kg 페이로드, 매출비중 40%(2024), 주요 경쟁사 [[Relativity Space\|Relativity Space]]
- 발사 비용: 약 720만 달러/회
...
- 중형 위성 발사체, 최대 8,000kg 페이로드, 매출비중 예상 15%(2026), 주요 경쟁사 [[2.개별종목/SpaceX\|SpaceX]]
...
- 소형 위성 플랫폼, 저궤도 및 심우주 임무용, 매출비중 30%(2024), 주요 경쟁사 [[York Space Systems\|York Space Systems]] 
...
- 위성 부품, 서브시스템 및 솔루션, 매출비중 20%(2024), 주요 경쟁사 Redwire Space [[2.개별종목/RDW\|RDW]]
...
- 턴키 방식의 위성 발사 솔루션, 매출비중 10%(2024), 주요 경쟁사 [[Arianespace\|Arianespace]]
...
- 사용처: 로켓 동체, 구조물 제작, Toray Industries(JP, [[3402\|3402]])
- 영향: 로켓의 무게와 강도를 결정하는 핵심 소재
- 가격 변동: 항공우주급 탄소섬유 공급 제한으로 가격 상승 가능성

**알루미늄 합금:**

- 사용처: 엔진 부품, 연료 탱크, 구조 프레임, Alcoa Corporation(US, [[2.개별종목/AA\|AA]])
- 영향: 구조적 무결성 및 열 관리에 중요
- 가격 변동: 글로벌 공급망 이슈로 인한 단기 변동성 있음

**고급 복합소재:**

- 사용처: 열 보호 시스템, 페이로드 페어링, Hexcel Corporation(US, [[2.개별종목/HXL\|HXL]])
- 영향: 극한 온도 및 압력 환경에서의 성능 결정
- 가격 변동: 항공우주 수요 증가에 따른 가격 상승 예상

**액체 산소:**

- 사용처: 로켓 산화제, 추진 시스템, Air Liquide(FR, [[AI\|AI]])
- 영향: 로켓 성능 및 추진력에 직접적 영향
- 가격 변동: 에너지 가격에 연동된 생산 비용 변동

**케로신(RP-1):**

- 사용처: 일렉트론 로켓 연료, Phillips 66(US, [[2.개별종목/PSX\|PSX]])
...
- 사용처: 로켓 및 위성 제어 시스템, 통신 장비, 센서, Microchip Technology(US, [[2.개별종목/MCHP\|MCHP]])
...
- Planet Labs(US, [[2.개별종목/PL\|PL]]) - 지구 관측 위성 군집
- Spire Global(US, [[2.개별종목/SPIR\|SPIR]]) - 해양, 항공, 기상 데이터 위성
- BlackSky(US, [[2.개별종목/BKSY\|BKSY]]) - 지구 관측 및 분석 서비스
- Satellogic(US, [[2.개별종목/SATL\|SATL]]) - 고해상도 지구 관측
- HawkEye 360(US, 비상장) - RF 신호 정보 수집 위성
- Kleos Space(AU, [[2.개별종목/KSS\|KSS]]) - RF 정찰 위성 서비스
...
- Lockheed Martin Space(US, [[2.개별종목/LMT\|LMT]]) - 위성 부품 공급
- Varda Space Industries(US, 비상장) - 우주 제조 플랫폼
- York Space Systems(US, 비상장) - 위성 시스템 통합
- L3Harris Technologies(US, [[2.개별종목/LHX\|LHX]]) - 우주 시스템 구성품
- Airbus Defence and Space(FR, [[2.개별종목/AIR\|AIR]]) - 위성 시스템
...
- Canon Electronics(JP, [[7739\|7739]]) - 소형 위성 개발
...
- United Launch Alliance(US, 합작회사 [[2.개별종목/LMT\|LMT]]/[[2.개별종목/BA\|BA]]) - 아틀라스 V, 불칸 센타우르, 시장 점유율 10%
- Arianespace(FR, 비상장) - 아리안 6, 베가, 유럽 시장 점유율 80%
- Northrop Grumman(US, [[2.개별종목/NOC\|NOC]]) - 앤타레스, 미노타우르, 국가 안보 발사 중심

**중소형 발사체 기업:**

- Relativity Space(US, 비상장) - 테란 1, 3D 프린팅 로켓, 개발 단계
- Astra Space(US, [[ASTR\|ASTR]]) - Rocket 4.0, 초소형 발사체, 개발 어려움 직면
...
- Planet Labs(US, [[2.개별종목/PL\|PL]]) - 지구 관측 위성 운영, 자체 위성 제조
- Maxar Technologies(US, [[2.개별종목/MAXR\|MAXR]]) - 대형 지구 관측 위성, 우주 인프라
- Redwire Space(US, [[2.개별종목/RDW\|RDW]]) - 우주 인프라, 위성 부품 제조
- York Space Systems(US, 비상장) - 표준화된 위성 플랫폼
- Spire Global(US, [[2.개별종목/SPIR\|SPIR]]) - 소형 위성 군집, 데이터 서비스
...
- 중국항천과기집단(CASC, CN, [[000901\|000901]]) - 창정 로켓 시리즈
- Roscosmos(RU, 국영기업) - 소유즈, 프로톤 로켓
- 인도우주연구기구(ISRO, IN, 국영기업) - PSLV, GSLV 로켓
- ispace(JP, [[9348\|9348]]) - 달 착륙선 및 로버
- Mitsubishi Heavy Industries(JP, [[7011\|7011]]) - H-IIA, H3 로켓
...
- 뉴트론 로켓 개발 및 상용화 (2025년 말 첫 발사 예정)
