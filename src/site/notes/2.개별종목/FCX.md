---
{"dg-publish":true,"permalink":"/2.개별종목/FCX/","created":"2024-08-29T12:15:37.519+09:00","updated":"2025-07-29T21:37:04.652+09:00"}
---
...
- 채굴장비 제조업: 대형 채굴장비 공급 - Caterpillar(US, [[2.개별종목/CAT\|CAT]]), Komatsu(JP, [[Komatsu\|Komatsu]])
- 에너지 공급업: 광산 운영 전력 공급 - Chevron(US, [[2.개별종목/CVX\|CVX]]), ExxonMobil(US, [[2.개별종목/XOM\|XOM]])
- 화학물질 공급업: 선별 및 정제용 화학물질 - Dow(US, [[2.개별종목/DOW\|DOW]]), DuPont(US, [[2.개별종목/DD\|DD]])
- 물류 및 운송업: 광물 운송 서비스 - Union Pacific(US, [[2.개별종목/UNP\|UNP]]), CSX(US, [[CSX\|CSX]])
...
- Freeport-McMoRan(US, [[2.개별종목/FCX\|FCX]]) - 자체 광산 운영
- 경쟁사: BHP(AU, [[2.개별종목/BHP\|BHP]]), Rio Tinto(UK, [[2.개별종목/RIO\|RIO]]), Southern Copper(US, [[2.개별종목/SCCO\|SCCO]])

**선별 및 정제 단계:** 광물 분리 및 순도 높은 금속 생산

- Atlantic Copper - 제련소 운영 (FCX 자회사)
- Aurubis(DE, [[Aurubis\|Aurubis]]) - 구리 제련 및 가공
- Glencore(CH, [[Glencore\|Glencore]]) - 종합 광물 거래 및 정제

**가공 및 유통 단계:** 최종 제품 형태로 가공 및 글로벌 유통

- Wieland Group(DE, [[Wieland Group\|Wieland Group]]) - 구리 가공 제품
- KME Group(DE, [[KME Group\|KME Group]]) - 구리 및 구리 합금 제품
- Mitsubishi Materials(JP, [[Mitsubishi Materials\|Mitsubishi Materials]]) - 금속 가공 및 유통

**최종 사용자 단계:** 제조업체 및 건설업체

- Tesla(US, [[2.개별종목/TSLA\|TSLA]]) - 전기차 배터리 및 모터용 구리
- Apple(US, [[2.개별종목/AAPL\|AAPL]]) - 전자기기 내부 구리 부품
- General Electric(US, [[2.개별종목/GE\|GE]]) - 발전기 및 전기 장비

---

## 주요제품

**구리 (Copper):** 전기차, 전자기기, 건설업 등에 사용, 매출 비중 약 53% (2024년 기준), 관련 경쟁사 [[2.개별종목/SCCO\|SCCO]], [[2.개별종목/BHP\|BHP]], [[2.개별종목/RIO\|RIO]]

**금 (Gold):** 보석, 전자기기, 투자 자산으로 사용, 매출 비중 약 35% (2024년 기준), 관련 경쟁사 [[2.개별종목/NEM\|NEM]], [[AEM\|AEM]], [[KGC\|KGC]]
...
- 사용처: 대형 채굴장비 운영용 연료
- 주요 공급 지역: 글로벌
- 주요 공급 업체: Chevron [[2.개별종목/CVX\|CVX]], ExxonMobil [[2.개별종목/XOM\|XOM]]
...
- ABB(CH, [[2.개별종목/ABB\|ABB]]) - 전력 및 자동화 기술용 구리 
- Honeywell(US, [[2.개별종목/HON\|HON]]) - 산업용 전자 시스템 
- 3M(US, [[2.개별종목/MMM\|MMM]]) - 전자 및 전기 제품용 구리 
- Johnson Controls(US, [[2.개별종목/JCI\|JCI]]) - 빌딩 자동화 시스템 
- Emerson Electric(US, [[2.개별종목/EMR\|EMR]]) - 산업 자동화 장비 
- Rockwell Automation(US, [[2.개별종목/ROK\|ROK]]) - 산업용 자동화 시스템
...
- BHP Group(AU, [[2.개별종목/BHP\|BHP]]) - 세계 최대 구리 생산업체, 철광석 및 구리 통합 운영
- Rio Tinto(UK, [[2.개별종목/RIO\|RIO]]) - 글로벌 광산업체, 구리 및 철광석 생산
- Southern Copper(US, [[2.개별종목/SCCO\|SCCO]]) - 남미 최대 구리 생산업체, 페루 및 멕시코 운영
- Glencore(CH, [[Glencore\|Glencore]]) - 종합 광물 거래업체, 구리 생산 및 거래
...
- Taseko Mines(CA, [[TKO\|TKO]]) - 캐나다 구리 생산업체
...
- Richard Adkerson (CEO): 0.12% (172만 주)
...
- SPDR S&P Global Natural Resources ETF - [[GNR\|GNR]]
- iShares Global Timber & Forestry ETF - [[WOOD\|WOOD]]